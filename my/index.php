...
//added by shiva core changes for user dashboard
//print_object(local_get_teacher_courses());die;
if(is_siteadmin($USER)){

}else if(local_get_teacher_courses()  && !empty(local_get_teacher_courses())){ //tutor
    redirect(new moodle_url('/local/learner/tutordash.php')); 
}else{//learner
    redirect(new moodle_url('/local/learner/mydash.php'));
}
//
