...
document.addEventListener("DOMContentLoaded", function () {
    ...
    blocker.innerHTML = `
        ...
        ">
            ...
            <p>Please complete the required task before accessing the course.</p>

            <!-- Change link to your assignment -->
            <a href="/mod/assign/view.php?id=123"
               style="display:inline-block;margin-top:15px;padding:10px 20px;
                      background:#0069d9;color:#fff;border-radius:5px;text-decoration:none;">
