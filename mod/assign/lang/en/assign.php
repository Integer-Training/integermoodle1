...
$string['relativedates'] = 'Relative dates (based on enrolment date)';
$string['enabledrelativedates'] = 'Enable relative dates';
$string['relativesubmitdays'] = 'Allow submissions after (days)';
$string['relativeduedays'] = 'Due date after (days)';
$string['relativecutoffdays'] = 'Cut-off date after (days)';
