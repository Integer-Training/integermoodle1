...
$name = 'theme_alpha/block24';
$title = get_string('block01', 'theme_alpha');
$description = get_string('block01_desc', 'theme_alpha');
$setting = new admin_setting_configselect($name, $title, $description, '24', $slotsarray);
$page->add($setting);

$name = 'theme_alpha/block25';
$title = get_string('block02', 'theme_alpha');
$description = get_string('block02_desc', 'theme_alpha');
$setting = new admin_setting_configselect($name, $title, $description, '25', $slotsarray);
$page->add($setting);
