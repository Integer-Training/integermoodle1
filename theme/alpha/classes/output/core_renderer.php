...
//return $content;
    ...
    public function mainsidebarmenu() {
        ...
        if ($theme->settings->iscustomitem1on == true && is_siteadmin($USER)) {
        ...
        if ($theme->settings->iscustomitem5on == true) {
            ...
            if(is_siteadmin($USER)){
                ...
                $user_link = new moodle_url('/local/learner/users.php', array('contextid' => 1));
                 $html .= '
                        <ul class="list-unstyled1 mb-0">
                            <li class="rui-sidebar-nav-item dropdown">
                                <a href="#" id="itemCustomItem2" class="rui-sidebar-nav-item-link dropdown-toggle" 
                                  data-bs-toggle="dropdown"
               aria-expanded="false" >
                                    <span class="rui-sidebar-nav-icon"><i class="fa-solid fa-graduation-cap"></i></span>
                                    <span class="rui-sidebar-nav-text">Tutor Management</span>
                                </a>

                                <ul class="dropdown-menu  tm-dropdown collapse tm-collapse">
                                    <li><a class="dropdown-item" href="'.$tutor_link.'">Tutors</a></li>
                                    <li><a class="dropdown-item" href="#">Outstanding Marking</a></li>
                                    <li><a class="dropdown-item" href="'.$mark_history.'">Marking History</a></li>
                                    <li><a class="dropdown-item" href="'.$reassign_link.'">Re-assign Caseload</a></li>
                                </ul>
                            </li>
                        </ul>
                   ...
                   .tm-dropdown {
                        ...
                        transform: none !important;    /* ← stop auto positioning */
                        float: none;
                    ...
                    .tm-header.show .tm-dropdown {
                        display: block;
                    }
                    .tm-dropdown .dropdown-item {
                        color: #704444 !important;
                        font-size: 12px;
                        background: transparent;
                    }
                    ...
                    <script>
                    document.querySelectorAll(".tm-dropdown .dropdown-item").forEach(function(item) {
                        item.addEventListener("click", function(e) {
                            e.stopPropagation();   // stops dropdown from closing
                        });
                    });
                    </script>
                    ';
