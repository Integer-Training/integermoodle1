        ...
        if ($prev || $next) {
            ...
            if ($prev) {
                ...
                $html .= html_writer::link(
                    $url,
                    '<svg class="me-2" width="16" height="16" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
            ...
            if ($next) {
                ...
                $html .= html_writer::link(
                    $url,
                    format_string($next->name) . '<svg class="ms-2" width="16" height="16" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
