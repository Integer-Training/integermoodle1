...
$PAGE->set_url(new moodle_url('/local/learnerprogression/index.php'));
$PAGE->set_context($context);
$PAGE->set_title(get_string('learnerprogressions', 'local_learnerprogression'));

$PAGE->requires->jquery();

// DataTables core (local files bundled with plugin).
$PAGE->requires->js('/local/learnerprogression/js/jquery.dataTables.min.js', true);
$PAGE->requires->css('/local/learnerprogression/js/jquery.dataTables.min.css');
...
// ===== ROLE DETECTION =====
$is_manager = has_capability('local/learnerprogression:view', $context);
$is_tutor = false;
$learner_ids = [];
