...
//
$PAGE->set_url(new moodle_url('/local/learner/tutorlearners.php'));
...
$tutor = $DB->get_record('user',['id'=>$id]);
...
echo '<div class="card-header-lms">
                        <h4 class="m-b-0 text-white headline-lms">
                            <div class="pull-left m-2" >
                                <strong style="padding-right:12px"> Total Learners of '.fullname($tutor).'</strong><span class="label label-rounded label-warning m-l-10 label-all">'.$count_recs.'</span>
                            </div>       
                        </h4>
        </div>';
echo '<br>';
