...
//
$PAGE->set_url(new moodle_url('/local/learner/inactive.php'));
...
$mform = new filters_inactive_form(null,[]);
if ($mform->is_cancelled()) {
    redirect(new moodle_url('/local/learner/inactive.php'));
} else {
...
if($fromform){
    ...
    $in_sql = "SELECT DISTINCT
        ...
        WHERE
            ...
            AND ctx.instanceid = ".$fromform->courses."
        ...
        //$records = $DB->get_records_sql($in_sql);
...
echo '<div class="card-header-lms">
                        <h4 class="m-b-0 text-white headline-lms">
                            ...
                            <a href="'.$CFG->wwwroot.'/admin/tool/uploaduser/index.php" target="_blank" class="btn btn-warning waves-effect waves-light pull-right mr-2">
                                <span class="btn-label">
                                    <i class="fa fa-lg fa-plus"></i>
                                </span>Bulk Learner Upload 
                            </a>     
